public class MyWebkitWindow : Gtk.Window {
    ...
    construct {
        ...
        var back_image = new Gtk.Image ();
        back_image.gicon = new ThemedIcon ("go-previous");
        ...
        var reload_image = new Gtk.Image.from_icon_name ("view-refresh-symbolic", Gtk.IconSize.SMALL_TOOLBAR);
        reload_button = new Gtk.ToolButton (reload_image, null);
        var stop_image = new Gtk.Image.from_icon_name ("process-stop-symbolic", Gtk.IconSize.SMALL_TOOLBAR);
    ...
    public static int main (string[] args) {
        ...
        my_webkit_window.open_url ("web/index.html");
